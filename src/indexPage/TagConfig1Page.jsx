    ...
    return (
        <div className="row">
            ...
            <div className="col-12 my-3 fadeItem1s d-flex flex-column">
                ...
                <span className=" fs-5 my-1">Com base na sua escolha, vamos sugerir categorias de <b>receitas</b> e <b>despesas</b> para facilitar o <b>controle financeiro</b>.</span>
            </div>
            <hr />
