...
import { faEllipsis, faGear, faGripLines, faPlus } from "@fortawesome/free-solid-svg-icons";
                                        ...
                                        <div className="card my-1 bg-white p-3" ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps} id={elem.id}>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-12 d-flex my-1 align-items-center mt-3">
                                                    <span type="button" className="px-2 small bold cardAnimation" style={{ border: `2px solid ${elem.color}`, borderRadius: '20px', color: elem.color }}>
                                                        + subcategoria
                                                    </span>
                                                </div>
                                            </div>
