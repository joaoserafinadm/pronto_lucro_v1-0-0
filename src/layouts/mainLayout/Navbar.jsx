                                ...
                                <Accordion defaultActiveKey="0">
                                    ...
                                    {akvoTool === "geeCalculator" && (
                                        <div className="fadeItem">
                                            <li>
                                                <ContextAwareToggle eventKey="11">
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="col-9 bold">Inventário</div>
                                            ...
                                            <li>
                                                <ContextAwareToggle eventKey="12">
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="col-9 bold">Gestão de Emissões</div>
                                                        <div className="col-1 toggleIcon text-end">
                                                            <FontAwesomeIcon icon={faAngleRight} className=" icon" />
                                                        </div>
                                                    </div>
                                                        ...
                                                        {userRestriction(["auditor"], token.userStatus) && (
                                                            <li>
                                                                <Link href="/inventoryManagement">
                                                                    <span>Metas e Planos de Ação</span>
                                                                </Link>
                                                            </li>
                                                        )}
                                                    </ul>
                                            ...
                                            <li>
                                                <ContextAwareToggle eventKey="13" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/offsetting")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faTree} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Compensação</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                        </div>
                                    ...
                                    {akvoTool === "esgIndicators" && (
                                        <div className="fadeItem">
                                            <li>
                                                <ContextAwareToggle eventKey="21" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/esgIndicators")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faClipboardCheck} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Formulário</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                            <li>
                                                <ContextAwareToggle eventKey="22" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/esgResults")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faChartSimple} className="me-2 icon" />
                                                        </div>
                                            ...
                                            <li>
                                                <ContextAwareToggle eventKey="23" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/esgManagement")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faListCheck} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Planos de ação</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                        </div>
                                    ...
                                    {akvoTool === "pcaf" && (
                                        <div className="fadeItem">
                                            ...
                                            <li>
                                                <ContextAwareToggle eventKey="31" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/pcafInstructions")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faBook} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Instruções</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                            <li>
                                                <ContextAwareToggle eventKey="32" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/contractsManagement")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faTable} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Gestão de Contratos</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                            <li>
                                                <ContextAwareToggle eventKey="33" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/pcafResults_2")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faChartColumn} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Resultados</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            ...
                                            <li>
                                                <ContextAwareToggle eventKey="34" collapse="InicioItem">
                                                    <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/pcafReportManagement")}>
                                                        <div className="col-1 text-center me-3">
                                                            <FontAwesomeIcon icon={faFileContract} className="me-2 icon" />
                                                        </div>
                                                        <div className="col-9 bold">Relatórios</div>
                                                    </div>
                                                </ContextAwareToggle>
                                            </li>
                                    ...
                                    {userRestriction(["user", "auditor"], token.userStatus) && (
                                        <li>
                                            ...
                                            <ContextAwareToggle eventKey="41" collapse="InicioItem">
                                                <div className="d-flex">
                                                    <div className="col-1 text-center me-3">
                                                        <FontAwesomeIcon icon={faBuildingUser} className="me-2 icon" />
                                                    </div>
                                                    <div className="col-9 bold">Instituição</div>
                                                    <div className="col-1 toggleIcon text-end">
                                                        <FontAwesomeIcon icon={faAngleRight} className=" icon" />
                                                    </div>
                                                </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <Link href="/companyStructure">
                                                            <span>Estrutura da Plataforma</span>
                                                        </Link>
                                                    </li>
                                                </ul>
                                            </Accordion.Collapse>
                                    ...
                                    {userRestriction(["auditor"], token.userStatus) && (
                                        <li>
                                            <ContextAwareToggle eventKey="51">
                                                <div className="d-flex">
                                                    <div className="col-1 text-center me-3">
                                                        <FontAwesomeIcon icon={faDiagramProject} className="me-2 icon" />
                                                    </div>
                                                    <div className="col-9 bold">Unidades</div>
                                                    <div className="col-1 toggleIcon text-end">
                                                        <FontAwesomeIcon icon={faAngleRight} className=" icon" />
                                                    </div>
                                                </div>
                                    ...
                                    {userRestriction(["user", "auditor"], token.userStatus) && (
                                        <li>
                                            <ContextAwareToggle eventKey="61" collapse="InicioItem">
                                                <div className="d-flex justify-content-start " type='button' onClick={() => router.push("/groups")}>
                                                    <div className="col-1 text-center me-3">
                                                        <FontAwesomeIcon icon={faObjectGroup} className="me-2 icon" />
                                                    </div>
                                                    <div className="col-9 bold">Grupos</div>
                                                </div>
                                            </ContextAwareToggle>
                                        </li>
                                    )}
                                    ...
                                    {userRestriction(["auditor"], token.userStatus) && (
                                        <li>
                                            <ContextAwareToggle eventKey="71">
                                                <div className="d-flex">
                                                    <div className="col-1 text-center me-3">
                                                        <FontAwesomeIcon icon={faUsers} className="me-2 icon" />
                                                    </div>
                                                    <div className="col-9 bold">Usuários</div>
                                                    <div className="col-1 toggleIcon text-end">
                                                        <FontAwesomeIcon icon={faAngleRight} className=" icon" />
                                                    </div>
                                                </div>
